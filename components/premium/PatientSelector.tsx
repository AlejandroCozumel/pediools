...
const { selectedPatient: globalSelectedPatient, setPatient } = usePremiumStore();
const [open, setOpen] = useState(false);
const [search, setSearch] = useState("");
const [selected, setSelected] = useState<Patient | null>(globalSelectedPatient);
        ...
        >
          {globalSelectedPatient ? (
            <span className="flex items-center gap-2">
              ...
              {globalSelectedPatient.firstName} {globalSelectedPatient.lastName}
            </span>
          ) : (
