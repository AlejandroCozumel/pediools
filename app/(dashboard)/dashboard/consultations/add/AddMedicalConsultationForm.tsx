...
const AddMedicalConsultationForm = ({ patientId }: { patientId: string }) => {
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Next steps and follow-up instructions</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Follow-up Date */}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Any additional remarks or observations</CardDescription>
            </CardHeader>
            <CardContent>
              <FormField
                control={form.control}
