...
export const metadata = {
  title: "CDC Growth Charts (Infant) - PediMath", // t('growthChartsTitle')
  description: "Child Growth Visualization (2-20 years)", // t('growthVisualizationSubtitle')
  openGraph: {
    title: "CDC Growth Charts (Infant) - PediMath", // t('growthChartsTitle')
    description: "Child Growth Visualization (2-20 years)", // t('growthVisualizationSubtitle')
    images: ["/og-image.jpg"],
    url: "https://www.pedimath.com/charts/infant-cdc-growth-chart",
    type: "website",
  },
  twitter: {
