...
const Charts = () => {
  const t = useTranslations('IntergrowthChartPage');
    ...
    <div className="my-4 md:my-6 flex flex-col gap-6 px-4">
      ...
      >
        <IntergrowthChartDisplay
          ...
          weekRangeAround={isFullCurveView ? 18 : 4}
        />
      </motion.div>
