...
import cdcData from "@/app/data/intergrowht-weight.json";
...
const IntergrowthChart = () => {
  ...
  const yAxisTicks = Array.from({ length: 11 }, (_, i) => i * 0.5); // 0 to 5 kg by 0.5
  const yAxisTicksMobile = Array.from({ length: 11 }, (_, i) => i * 1);
                ...
                <div>
                  {chartData.patientData.value && (
                    <Badge variant="outline">
                      Weight: {chartData.patientData.value} kg
                    </Badge>
                  )}
                </div>
                <div>
...
export default IntergrowthChart;
