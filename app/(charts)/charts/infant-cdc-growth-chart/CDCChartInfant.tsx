...
import cdcData from "@/app/data/cdc-data-infant-weight.json";
...
const CDCChartInfant = ({ data }: ChartProps) => {
  ...
  const generateFullCurveData = (
    ...
    let allData = ages.map((age) => {
      ...
      const dataPoint = findClosestDataPoint(age, gender, cdcData, "weight");
